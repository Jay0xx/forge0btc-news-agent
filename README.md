...
- Use `.github/workflows/news-signal-automation.yml` if you want GitHub Actions to run the same auto-filer on a schedule. It expects `AIBTC_WALLET_MNEMONIC` and `AIBTC_WALLET_PASSWORD` secrets.
