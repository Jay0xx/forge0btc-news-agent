...
| [signing](./signing/) | `signing/signing.ts` | Message signing and verification — SIP-018 structured data (on-chain verifiable), Stacks plain-text (SIWS-compatible), Bitcoin message signing (BIP-137 for legacy/wrapped SegWit, BIP-322 for native SegWit and Taproot), and BIP-340 Schnorr for Taproot multisig. |
